      ...
      <div className='flex justify-center items-center'>
        ...
        >
          ...
          <Input placeholder='Search' className=' rounded-sm'/>
            <MenuItem className='hover:bg-[#173e26] hover:bg-opacity-20 p-2'>Ease of doing business rank (1=most business-friendly regulations)</MenuItem>
            <MenuItem className='hover:bg-[#173e26] hover:bg-opacity-20 p-2'>Effective corporate tax rate  (% of profit)</MenuItem>
            <MenuItem className='hover:bg-[#173e26] hover:bg-opacity-20 p-2'>Firms experiencing electrical outages (% of firms) 100%</MenuItem>
            <MenuItem className='hover:bg-[#173e26] hover:bg-opacity-20 p-2'>Firms experiencing losses due to theft and vandalism (% of firms)</MenuItem>
            <MenuItem className='hover:bg-[#173e26] hover:bg-opacity-20 p-2'>Firms using banks to finance working capital (% of firms)</MenuItem>
