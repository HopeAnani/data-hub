...
import pic2 from '../images/Illustrator.png'
import Components from './fourComponents'

const Explorecomp = () => {
  return (
    <div>
        <div className='min-h-[70vh] flex flex-col md:flex-row justify-center place-items-center center items-center  gap-10 md:mx-32 mt-10 '>
            ...
            <div className='md:w-2/4 text-center'>
                ...
                <p className='mt-5 text-justify self-center'>
        ...
        <div className='min-h-[70vh] flex flex-col md:flex-row justify-center place-items-center center items-center  gap-6 md:mx-32 mt-10 '>
